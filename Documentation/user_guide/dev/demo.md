...
The visual representation of the pin configurations clearly shows that all pins of each amoebot are contained in a single partition set and that all partition sets are connected in a global circuit.
