    ...
    public class CollisionLineDrawer : MonoBehaviour
    {
        ...
        */
        ...
        public void AddLine(Vector2Int start, Vector2Int end, Color color, bool arrow = false)
        {
            ...
            Vector2 startWorld = AmoebotFunctions.CalculateAmoebotCenterPositionVector2(start);
            Vector2 endWorld = AmoebotFunctions.CalculateAmoebotCenterPositionVector2(end);
