...
namespace AS2.Visuals
{
    ...
    public class RendererCircuits_RenderBatch_deprecated : IGenerateDynamicMesh
    {
        ...
        private void CalculateAnimationFrame()
        {
            ...
            if (properties.animated && RenderSystem.animationsOn) interpolationPercentage = Library.InterpolationConstants.SmoothLerp(RenderSystem.animation_curAnimationPercentage);
