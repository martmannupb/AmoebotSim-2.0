...
namespace AS2.Algos.SingleSourceSP
{
    ...
    public class SingleSourceSPParticle : ParticleAlgorithm
    {
        ...
        public static new string Name => "Shortest Path Forest (Single Source)";
        ...
        private void ActivatePortalPhase()
        {
            ...
            else if (round == 7)
            {
                ...
                UpdateParentCounter(portalAxisDir.GetValue().Rotate60(1), 0);
                UpdateParentCounter(portalAxisDir.GetValue().Rotate60(2), 0);
                UpdateParentCounter(portalAxisDir.GetValue().Rotate60(-1), 1);
                UpdateParentCounter(portalAxisDir.GetValue().Rotate60(-2), 1);
        ...
        private void ActivateFinalPrunePhase()
        {
            ...
            else if (round == 1)
            {
                ...
                if (isSource)
                {
                    ...
                    SendBeepOnPartitionSet(d.ToInt() * 2);
                }
            }
            else if (round == 2)
            {
                Direction d = ett.GetNeighborDirections()[0];
                if (!ReceivedBeepOnPartitionSet(d.ToInt() * 2) && !ReceivedBeepOnPartitionSet(d.ToInt() * 2 + 1))
                {
        ...
        {
            if (HasNeighborAt(d) && ReceivedBeepOnPartitionSet(pSet))
